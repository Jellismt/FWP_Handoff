...
For what it would take to replace this wrapper with a native application —
either two (Swift + Kotlin) or one (Flutter) — see
[SWIFTKOTLIN_NATIVE_MIGRATION_GUIDE.md](SWIFTKOTLIN_NATIVE_MIGRATION_GUIDE.md)
and [FLUTTER_MIGRATION_GUIDE.md](FLUTTER_MIGRATION_GUIDE.md).
