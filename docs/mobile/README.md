...
> **Thinking about going native?** This page documents the shipped Capacitor
> wrapper. What a rewrite would take — what ports, what does not, and what it
> would cost — is in
> [../SWIFTKOTLIN_NATIVE_MIGRATION_GUIDE.md](../SWIFTKOTLIN_NATIVE_MIGRATION_GUIDE.md)
> (two native apps) and
> [../FLUTTER_MIGRATION_GUIDE.md](../FLUTTER_MIGRATION_GUIDE.md) (one Flutter
> codebase). The plugin list below is the shopping list either route starts from.
